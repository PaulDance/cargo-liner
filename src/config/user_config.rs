    ...
    fn test_deser_userconfig_detailed_requirements() {
        ...
        .map(|(name, req)| {
            (
                ...
                (
                    ...
                    req.git().map(ToOwned::to_owned),
                    req.branch().map(ToOwned::to_owned),
                    req.tag().map(ToOwned::to_owned),
                    req.rev().map(ToOwned::to_owned),
        ...
        let expected = [
            ...
            (
                ...
                None,
                None,
                Some("https://mygit.com/abc/123".to_owned()),
                None,
                None,
                None,
                vec![],
            ...
            (
                ...
                None,
                None,
                Some("master-and-servant".to_owned()),
                None,
                None,
                vec![],
                BTreeMap::new(),
